<div id="textTypingWidgetPopUp"
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-2xl w-[90%] max-w-md flex flex-col gap-4 overflow-hidden">
        <h2 class="text-2xl font-semibold p-5 phaedra-scondary-backgroundcolor">TextTyping bearbeiten</h2>

        <div class="px-5 pb-5 flex flex-col gap-2">
            <div class="flex flex-col gap-1">
                <label for="textTypingWidgetRotationText" class="text-2xl phaedra-primary-color font-semibold">Typing Text</label>
            ...
            <div class="flex flex-col gap-1">
                <label for="textTypingWidgetContent" class="text-2xl phaedra-primary-color font-semibold">Inhalt</label>

<div id="videoWidgetPopup"
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-2xl w-[90%] max-w-md flex flex-col gap-4 overflow-hidden">
        <h2 class="text-2xl font-semibold p-5 phaedra-scondary-backgroundcolor">Video bearbeiten</h2>
        ...
        <div class="px-5 pb-5 flex flex-col gap-2">
            ...
            <div class="flex flex-col">
                ...
                <!-- Button für Popup -->
                <button id="openVideoSelectorBtn" type="button" class="mt-5 phaedra-scondary-backgroundcolor text-white px-4 py-2 rounded-md">
                    Logo aus Bibliothek auswählen
                </button>
            </div>

            <div class="flex flex-col gap-1">
                <label for="widgetVideoDesc" class="text-2xl phaedra-primary-color font-semibold">Beschreibung</label>

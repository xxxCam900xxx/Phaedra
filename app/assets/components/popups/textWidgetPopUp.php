...
>
    <div class="bg-white rounded-2xl border border-gray-200 shadow-2xl p-6 w-[90%] max-w-md flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-1">
            <label for="textWidgetTitle" class="text-sm font-medium text-gray-600">Titel</label>
        ...
        <div class="flex flex-col gap-1">
            <label for="textWidgetContent" class="text-sm font-medium text-gray-600">Content</label>

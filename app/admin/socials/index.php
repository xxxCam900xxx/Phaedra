    ...
    <main class="flex flex-row h-screen">
        ...
        <section class="flex flex-col w-full lg:flex-row gap-8 p-8">
            ...
            <div class="w-full lg:w-2/3 flex flex-col gap-5 bg-white overflow-hidden rounded-lg shadow-lg h-fit">
                <h2 class="text-2xl phaedra-scondary-backgroundcolor font-semibold p-5">Social Übersicht</h2>
                <div class="px-5">
            ...
            <div class="w-full lg:w-1/3 bg-white shadow-lg rounded-lg h-fit overflow-hidden">
                <h2 class="text-2xl font-semibold mb-4 p-5 phaedra-scondary-backgroundcolor">Social bearbeiten</h2>
                <form id="newSocialForm" class="space-y-5 px-5 pb-5">
                    <input type="hidden" name="ID" id="ID">

                    <div>
                        <label class="text-2xl phaedra-primary-color font-semibold" for="Icon">Icon (Benutze Font-Awsome Klassen)</label>
                        <input type="text" name="Icon" id="Icon"
                            class="w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200" />
                    </div>

                    <div>
                        <label class="text-2xl phaedra-primary-color font-semibold" for="Social">Social</label>
